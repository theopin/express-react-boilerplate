...
function createToast (message: string, bgColor: string): void {
...
export const ToastUtils = {
  createSuccessToast: (message: string) => { createToast(message, 'success') },
  createErrorToast: (message: string) => { createToast(message, 'danger') }
}
